...
function PCWorkIntel(){
    ...
    <div className="section-sb">
        ...
        <div className="section-sb-current">
            <h3><a href="/PCW">PC<span id="section-sb-toggle" className="section-sb-toggle"><span className="section-sb-ico"></span></span></a></h3>
    ...
    <div className="section-cont">
        ...
        {/* <!-- Catalog Topbar - end --> */}
        <div className="prod-items section-items" id="PCWorkIntel">
                        {item.PCWork.map( PC =>(
                            <ProductItem
                            key={PC.id}
                            image={PC.image}
